      ...
      >
        ...
        >
          <div className="w-full flex overflow-hidden whitespace-nowrap py-3">
            ...
            >
              {[...Array(4)].map((_, i) => (
                <div key={i} className="flex items-center gap-8 text-[14px]">
                  <span>
                    Unlock the power of real-time multi-location diamond inventory control -{" "}
                    <Link
                      href="#"
              ...
              <Link href="#trial">
                ...
                >
                  ...
                  <div className="flex items-center justify-center w-8 h-8 rounded-full bg-white text-[#111827] transition-transform duration-300 group-hover:rotate-45">
                    <ArrowUpRight weight="bold" className="w-[14px] h-[14px]" />
                  </div>
                </motion.div>
              </Link>
            </div>
