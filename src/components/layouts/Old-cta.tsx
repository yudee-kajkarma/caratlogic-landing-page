  <main className="relative min-h-fit flex flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-[#FAFAFA] via-[#e8f5e9] to-[#FAFAFA] animate-gradient-xy">
                {/* Background Image */}
